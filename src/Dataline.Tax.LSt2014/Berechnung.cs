...
namespace Dataline.Tax.LSt2014
{
    public class Berechnung
    {
        ...
        /// </summary>
        private const decimal ZAHL0 = 0m;
        private const decimal ZAHL1 = 1m;
        private const decimal ZAHL2 = 2m;
        private const decimal ZAHL3 = 3m;
        private const decimal ZAHL4 = 4m;
        private const decimal ZAHL5 = 5m;
        private const decimal ZAHL6 = 6m;
        private const decimal ZAHL7 = 7m;
        private const decimal ZAHL8 = 8m;
        private const decimal ZAHL9 = 9m;
        private const decimal ZAHL10 = 10m;
        private const decimal ZAHL11 = 11m;
        ...
        /// Neuer Wert  2014
        /// </summary>
        private const decimal RENTBEMESSUNGSGR_OST = 60000m;

        /// <summary>
        /// Neuer Wert 2014
        /// </summary>
        private const decimal RENTBEMESSUNGSGR_WEST = 71400m;
        ...
        /// </summary>
        private decimal zveEkSt { get; set; } = 0m;

        private decimal zveGemeinsam { get; set; } = 0m;
        ...
        /// </summary>
        private decimal VSPKURZ { get; set; } = 0m;
        ...
        private void UPEVP()
        {
            ...
            else
            {
                if ((KRV == 0))
                {
                    if ((CompareTo(ZRE4VP, RENTBEMESSUNGSGR_WEST) == 1))
                    {
                ...
                {
                    if ((CompareTo(ZRE4VP, RENTBEMESSUNGSGR_OST) == 1))
                    {
                        ZRE4VP = RENTBEMESSUNGSGR_OST;
                    }
                }

                VSP1 = Floor((ZRE4VP * 0.56m), 2);
                VSP1 = Floor((VSP1 * 0.0945m), 2);
            }
        ...
        private void MVSP()
        {
            ...
            if ((PKV > 0))
            {
                ...
                else
                {
                    ...
                    if ((PKV == 2))
                    {
                        KVSATZAG = System.Math.Round(0.07m, 5, System.MidpointRounding.AwayFromZero);
                        if ((PVS == 1))
                        {
                            PVSATZAG = System.Math.Round(0.00525m, 5, System.MidpointRounding.AwayFromZero);
                        }
                        else
                        {
                            PVSATZAG = System.Math.Round(0.01025m, 5, System.MidpointRounding.AwayFromZero);
                        }
            ...
            {
                KVSATZAN = System.Math.Round(0.079m, 5, System.MidpointRounding.AwayFromZero);
                if ((PVS == 1))
                {
                    PVSATZAN = System.Math.Round(0.01525m, 5, System.MidpointRounding.AwayFromZero);
                }
                else
                {
                    PVSATZAN = System.Math.Round(0.01025m, 5, System.MidpointRounding.AwayFromZero);
                }
        ...
        private void UMVSP()
        {
            VSPVOR = Floor((VSPVOR - (ZRE4VP * 0.16m)), 2);
            if ((CompareTo(VSPVOR, 0m) == (-1)))
            {
                VSPVOR = 0m;
            }

            if ((CompareTo(VSPO, VSPVOR) == 1))
            {
                VSP = VSPVOR;
                VSPREST = (VSPO - VSPVOR);
                if ((CompareTo(VSPREST, VSPMAX1) == 1))
                {
                    VSP = (VSP + VSPMAX1);
                    VSPREST = Ceiling(((VSPREST - VSPMAX1) / ZAHL2), 2);
                    if ((CompareTo(VSPREST, VSPMAX2) == 1))
                    {
                        VSP = Floor((VSP + VSPMAX2), 0);
                    }
                    else
                    {
                        VSP = Floor((VSP + VSPREST), 0);
                    }
                }
                else
                {
        ...
        {
            ZZX = X;
            if ((CompareTo(ZZX, 26441m) == 1))
            {
                ZX = 26441m;
                UP5_6();
                if ((CompareTo(ZZX, 200584m) == 1))
                {
                    ST = Floor((ST + ((200584m - 26441m) * 0.42m)), 0);
                    ST = Floor((ST + ((ZZX - 200584m) * 0.45m)), 0);
                }
                else
                {
                    ST = Floor((ST + ((ZZX - 26441m) * 0.42m)), 0);
                }
            }
            else
            {
                ZX = ZZX;
                UP5_6();
                if ((CompareTo(ZZX, 9763m) == 1))
                {
                    VERGL = ST;
                    ZX = 9763m;
                    UP5_6();
                    HOCH = Floor((ST + ((ZZX - 9763m) * 0.42m)), 0);
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            ST = Floor(((X * 0.42m) - 8239m), 0);
                        }
                        else
                        {
                            ST = Floor(((X * 0.45m) - 15761m), 0);
                        }
                    }
                }
            }
