...
namespace Dataline.Tax.LSt201512
{
    public class Berechnung
    {
        ...
        /// </summary>
        private int SCHLEIFZ { get; set; } = 0;
        ...
        /// </summary>
        private decimal ZRE4VPM { get; set; } = 0m;
        ...
        private void MLST1215()
        {
            if ((LZZ > 1))
            {
                JW = Floor((JWLSTN - (11m * (JWLSTA - JWLSTN))), 0);
                if ((CompareTo(JW, 0m) == (-1)))
                {
                    ANTEIL1 = 0m;
                }
                else
                ...
                LSTLZZ = ANTEIL1;
                JW = Floor((JWSOLZN - (11m * (JWSOLZA - JWSOLZN))), 0);
                if ((CompareTo(JW, 0m) == (-1)))
                {
                    ANTEIL1 = 0m;
                }
                ...
                SOLZLZZ = ANTEIL1;
                JW = Floor((JWBKN - (11m * (JWBKA - JWBKN))), 0);
                if ((CompareTo(JW, 0m) == (-1)))
                {
                    ANTEIL1 = 0m;
                }
